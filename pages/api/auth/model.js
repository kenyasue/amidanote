...
var config = {
	clients: [{
		id: 'amidanoteStandalone',	// TODO: Needed by refresh_token grant, because there is a bug at line 103 in https://github.com/oauthjs/node-oauth2-server/blob/v3.0.1/lib/grant-types/refresh-token-grant-type.js (used client.id instead of client.clientId)
		clientId: 'amidanoteStandalone',
		clientSecret: 'amidanoteSecret',
		grants: [
			"authorization_code"
		],
		redirectUris: ["http://localhost:3000/api/auth/callback/amidanoteStandalone"]
	}],
	confidentialClients: [{
		clientId: 'amidanoteStandalone',
		clientSecret: 'amidanoteSecret',
...
var saveAuthorizationCode = function(code, client, user) {
    ...
    config.authCodes.push(authCode);
